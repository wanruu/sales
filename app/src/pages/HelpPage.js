...
import { EditOutlined, DeleteOutlined, QuestionCircleOutlined, DownOutlined, UpOutlined } from '@ant-design/icons'
            ...
            <li>产品条目：
                <ol>
                    <li>单位：填入<span style={{ fontWeight: 'bold' }}>材质、名称、规格</span>
                        后，如果该产品已存在，单位会自动填入且不可修改。如需修改单位，需要到<span style={{ fontWeight: 'bold' }}>产品页面</span>修改，且所有相关单据都会被修改，金额可能会发生变化（如当单位从“千件”改为“只”时）。
                    </li>
                    <li>删除：点击按钮“<Button type='link' size='small' danger icon={<DeleteOutlined/>}/>”可删除整行数据。</li>
                </ol>
            </li>
            <li>保存机制：新客户、新产品会被创建，已经存在的产品的库存会相应改变，但
                <span style={{ color: 'red', fontWeight: 'bold' }}>不会</span>
                删除产品。</li>
        </ol> },
        { key: 'modifyOrderMechanism', title: '修改或删除销售/采购单的机制', content: <ol>
            <li>会影响相关的产品库存，但<span style={{ color: 'red', fontWeight: 'bold' }}>不会</span>删除产品。</li>
            <li>修改产品<span style={{ fontWeight: 'bold' }}>材质、名称、规格、数量、备注</span>
                <span style={{ color: 'red', fontWeight: 'bold' }}>不会</span>
